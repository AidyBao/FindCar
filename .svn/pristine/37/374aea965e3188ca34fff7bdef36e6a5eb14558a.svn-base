...
class ZXCountDownButton: UIButton {
    ...
    func uiconfig() {
        ...
        self.setTitleColor(UIColor.zx_textColorTitle, for: .disabled)
        self.setImage(#imageLiteral(resourceName: "resend"), for: .normal)
        self.setImage(UIImage.init(), for: .disabled)
    }
    ...
    func reset() {
        ...
        self.setTitle(idleTitle, for: .normal)
        self.setTitle(idleTitle, for: .disabled)
        self.titleLabel?.textColor = UIColor.zx_textColorTitle
        self.isEnabled = true
        isCouting = false
    }
