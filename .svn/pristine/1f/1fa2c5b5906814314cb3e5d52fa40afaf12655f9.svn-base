...
public class ZXBannerPageControl: UIView {
    ...
    public var alignment: ZXPageControlAlignment = .center {
        didSet {
            ...
            case .center:
                pageIndicatorBackView.frame = CGRect.init(x: 0, y: 0, width: indicator_width, height: 4)
    ...
    private func setupPageIndicatorView() {
        ...
        pageIndicatorBackView.backgroundColor = UIColor.zx_backgroundColor
        addDotView()
    }
