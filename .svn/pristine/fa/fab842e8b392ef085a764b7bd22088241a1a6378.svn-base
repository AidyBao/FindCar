...
//        setTotalCount()
    ...
    private func setSubviews() {
        ...
        collectionView = UICollectionView(frame: CGRect.init(x: 0, y: 0, width: self.frame.size.width, height: self.frame.size.height - 4), collectionViewLayout: layout)
        collectionView?.backgroundColor = UIColor.zx_backgroundColor
        ...
        pageControl = ZXBannerPageControl(frame: CGRect(x: 0, y: (collectionView?.frame.maxY)!, width: UIScreen.main.bounds.size.width, height: 4))
    ...
    override func layoutSubviews() {
        ...
        self.collectionView?.frame = CGRect.init(x: 0, y: 0, width: self.frame.size.width, height: self.frame.size.height - 4)
        self.pageControl?.frame = CGRect(x: 0, y: (collectionView?.frame.maxY)!, width: self.frame.size.width, height: 4)
    }
